...
export default async function TenantHome({ params }: PageProps) {
  ...
  return (
    <article>
      <header>
        <h1 style={{ fontSize: "2rem", marginBottom: "0.5rem" }}>Welkom bij {brandName}</h1>
        <AiAssistedBadge />
      </header>
      <p style={{ marginTop: "1rem", lineHeight: 1.6 }}>
        Dit is een placeholder homepage. De Content Agent levert hier in Phase 4 de echte landing —
        een topic-hub met links naar de gepubliceerde pagina's, gefilterd op intent en seizoen.
      </p>
